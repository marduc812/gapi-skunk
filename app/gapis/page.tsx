...
const About = () => {
    ...
    return (
        <main className='flex min-h-screen flex-col items-center px-24'>
            ...
            <p className='text-center w-full text-slate-700'>Details about the API calls tested. Information about their purpose, their price tiers and links for the documentaiton provided by Google.</p>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-4'>

                {
                    rules.map((rule) => {
                        ...
                        return (
                            <div key={`${rule.name}-about`} className='flex flex-col justify-between border-4 border-black rounded-md m-5 p-5 items-center w-full shadow-[5px_5px_0px_0px_rgba(0,0,0)]'>
                                ...
                                <div className='flex flex-row w-full justify-between'>
                                    <div className='text-lg flex flex-row justify-left items-center'>
                                        <span className='m-2 font-bold'>Pricing:</span>
                                        <PriceView price={rule.price} />
                                    </div>

                                    <div className='text-lg flex flex-row justify-right items-center'>
